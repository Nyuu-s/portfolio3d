      ...
      switch (RoomState) {
        ...
        case 'rocket':
          ...
          if((group && group.current) && RocketCam.current){
            ...
            timeline.to(cam.current.position, {y: 10,  duration: 10})
            timeline.to(Rocket.current.position, { y: 50, duration: 10, onComplete: () => {setrocketClick(false)}}, '<')
            timeline.to(Rocket.current.position, { y: 100, duration: 5})
    ...
    <group ref={group} {...props}  scale={0.21} position={[0,-1,0]} >
      ...
      <group ref={scene} name="Scene"  >
        ...
        <mesh name="Plane" castShadow receiveShadow geometry={nodes.Plane.geometry} material={materials.WindowFrame} position={[-0.73, 5.56, -3.31]} rotation={[-Math.PI / 2, 0, Math.PI / 4]} />
          ...
          <group name="Rocket" ref={Rocket} position={[-4.26, 4.86, 0.63]} rotation={[0, 1.2, 0]} 
            ...
            onPointerOver={(e) => { 
              ...
              e.eventObject.children.forEach(mesh => {
                if(mesh.isMesh)
                  mesh.material.emissive = {r: 1, g:0, b:0}
              })
            ...
            onPointerOut={(e) => { 
              e.eventObject.children.forEach(mesh => {
                // mesh.name === "Cone" ? mesh.material = materials['Rocket.001'] : mesh.material = materials.RocketTop
                if(mesh.isMesh)
                  mesh.material.emissive =  {r: 0, g:0, b:0}
              })
        ...
        <mesh name="screen" 
          castShadow receiveShadow geometry={nodes.screen.geometry} material={materials['ScreenPC.001']} position={[-3.18, 2.53, -0.19]} rotation={[0, Math.PI / 4, 0]} />
        <mesh name="screen001" onPointerOver={(e) => {  document.body.style.cursor = 'pointer';} }  onPointerOut={(e) => { document.body.style.cursor = 'default'; }} ref={PCScreen} castShadow receiveShadow geometry={nodes.screen001.geometry} material={materials['Screen.001']} position={[-3.18, 2.53, -0.19]} rotation={[0, Math.PI / 4, 0]} />
